...
#line 53 "./src/grammar.y"
                      {printf("Program call\n");}
#line 550 "./src/grammar.c"
    break;

  case 4:
#line 57 "./src/grammar.y"
        {yylineno+=1;}
#line 556 "./src/grammar.c"
    break;
...
#line 649 "./src/grammar.c"
    break;


#line 653 "./src/grammar.c"
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
       0,    52,    52,    53,    57,    58,    62,    67,    71,    72,
      75,    78,    81,    85,    90,    91,    96,   100,   104,   108
  };
